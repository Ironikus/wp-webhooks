...
<?php echo WPWHPRO()->helpers->translate( "This webhook trigger is used to send data, on creation of a user, to one or multiple given webhook URL's.", $translation_ident ); ?>
<br>
...
<pre>add_action( 'user_register', array( $this, 'ironikus_trigger_user_register_init' ), 10, 1 );</pre>
