<?php
if ( ! class_exists( 'WP_Webhooks_Trigger_post_update' ) ) :
	 ...
	 */
	class WP_Webhooks_Trigger_post_update {
		...
		public function add_trigger_details( $triggers ){
			...
			$triggers['post_update'] = $this->trigger_post_update_content();
        ...
        * @since 1.2
        */
        public function trigger_post_update_content(){
...
<pre>add_action( 'wp_insert_post', array( $this, 'ironikus_trigger_post_update_init' ), 10, 3 );
