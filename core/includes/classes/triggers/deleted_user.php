<?php
if ( ! class_exists( 'WP_Webhooks_Trigger_deleted_user' ) ) :
	 ...
	 */
	class WP_Webhooks_Trigger_deleted_user {
		...
		public function add_trigger_details( $triggers ){
			...
			$triggers['deleted_user'] = $this->trigger_deleted_user_content();
        ...
        public function trigger_deleted_user_content(){
            ...
            ob_start();
?>
<?php echo WPWHPRO()->helpers->translate( "This webhook trigger is used to send data, after deletion of a user, to one or multiple given webhook URL's.", $translation_ident ); ?>
<br>
<?php echo WPWHPRO()->helpers->translate( "This description is uniquely made for the <strong>Send Data On User Deletion</strong> (deleted_user) webhook trigger.", $translation_ident ); ?>
<br><br>
<h4><?php echo WPWHPRO()->helpers->translate( "How to use <strong>Send Data On User Deletion</strong> (deleted_user)", $translation_ident ); ?></h4>
<ol>
...
<br>
<?php echo WPWHPRO()->helpers->translate( "This trigger is registered on the <strong>deleted_user</strong> hook:", $translation_ident ); ?> 
<a title="wordpress.org" target="_blank" href="https://developer.wordpress.org/reference/hooks/deleted_user/">https://developer.wordpress.org/reference/hooks/deleted_user/</a>
<br>
<br>
<?php echo WPWHPRO()->helpers->translate( "<strong>Important</strong>: If case have a multisite network set up, this webhook only fires if you delete the user from the whole network and not only from one sub site.", $translation_ident ); ?>
<br>
<br>
