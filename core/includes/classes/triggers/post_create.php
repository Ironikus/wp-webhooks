<?php
if ( ! class_exists( 'WP_Webhooks_Trigger_post_create' ) ) :
	 ...
	 */
	class WP_Webhooks_Trigger_post_create {
		...
		public function add_trigger_details( $triggers ){
			...
			$triggers['post_create'] = $this->trigger_post_create_content();
        ...
        * @since 1.2
        */
        public function trigger_post_create_content(){
