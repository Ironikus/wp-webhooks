<?php
if ( ! class_exists( 'WP_Webhooks_Trigger_post_trash' ) ) :
	 ...
	 */
	class WP_Webhooks_Trigger_post_trash {
		...
		public function add_trigger_details( $triggers ){
			...
			$triggers['post_trash'] = $this->trigger_post_trash_content();
        ...
        * @since 3.0.4
        */
        public function trigger_post_trash_content(){
