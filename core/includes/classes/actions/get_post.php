<?php
if ( ! class_exists( 'WP_Webhooks_Action_get_post' ) ) :
	 ...
	 */
	class WP_Webhooks_Action_get_post {
		...
		public function add_action_details( $actions ){
			...
			$actions['get_post'] = $this->action_get_post_content();
