<?php
if ( ! class_exists( 'WP_Webhooks_Action_get_user' ) ) :
	 ...
	 */
	class WP_Webhooks_Action_get_user {
		...
		public function add_action_details( $actions ){
			...
			$actions['get_user'] = $this->action_get_user_content();
