...
<?php
			...
			ob_start();
			?>
<?php echo WPWHPRO()->helpers->translate( "This webhook action allows you to create a Woocommerce order within a single webhook call.", $translation_ident ); ?>
<br>
<?php echo WPWHPRO()->helpers->translate( "This description is uniquely made for the <strong>create_woocommerce_order</strong> webhook action.", $translation_ident ); ?>
<br>
...
<br><br>
<h4><?php echo WPWHPRO()->helpers->translate( "How to use <strong>create_woocommerce_order</strong>", $translation_ident ); ?></h4>
<ol>
    <li><?php echo WPWHPRO()->helpers->translate( "The first argument you need to set within your webhook action request is the <strong>action</strong> argument. This argument is always required. Please set it to <strong>create_woocommerce_order</strong>.", $translation_ident ); ?></li>
