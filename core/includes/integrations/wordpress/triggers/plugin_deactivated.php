...
<?php echo WPWHPRO()->helpers->translate( "This webhook trigger is used to send data, on the deactivation of a plugin, to one or multiple given webhook URL's.", $translation_ident ); ?>
<br>
<?php echo WPWHPRO()->helpers->translate( "This description is uniquely made for the <strong>Send Data On Plugin Deactivation</strong> (plugin_deactivated) webhook trigger.", $translation_ident ); ?>
<br><br>
<h4><?php echo WPWHPRO()->helpers->translate( "How to use <strong>Send Data On Plugin Deactivation</strong> (plugin_deactivated)", $translation_ident ); ?></h4>
<ol>
...
<br>
<?php echo WPWHPRO()->helpers->translate( "This trigger is registered on the <strong>deactivated_plugin</strong> hook:", $translation_ident ); ?> 
...
<pre>add_action( 'deactivated_plugin', array( $this, 'ironikus_trigger_plugin_deactivated' ), 10, 2 );</pre>
<br><br>
