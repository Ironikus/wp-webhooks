...
if ( ! class_exists( 'WP_Webhooks_Integrations_wordpress_Triggers_create_comment' ) ) :
	...
	class WP_Webhooks_Integrations_wordpress_Triggers_create_comment {
        ...
        public function get_details(){
			...
			ob_start();
			?>
			<p><?php echo WPWHPRO()->helpers->translate( "Please copy your Webhooks Pro webhook URL into the provided input field. After that you can test your data via the Send demo button.", $translation_ident ); ?></p>
