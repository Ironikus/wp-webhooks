...
<?php echo WPWHPRO()->helpers->translate( "This webhook action is used to assign one or multiple taxonomy terms to a post via a webhook call. In case the added taxonomy term doesn't exist, it will be created.", $translation_ident ); ?>
<br>
