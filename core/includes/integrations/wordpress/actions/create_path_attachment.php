...
if ( ! class_exists( 'WP_Webhooks_Integrations_wordpress_Actions_create_path_attachment' ) ) :
	...
	class WP_Webhooks_Integrations_wordpress_Actions_create_path_attachment {
        ...
        public function get_details(){
			...
			ob_start();
			?>
<?php echo WPWHPRO()->helpers->translate( "This webhook action is used to create an attachment from a server path on your WordPress system via a webhook call.", $translation_ident ); ?>
<br>
<?php echo WPWHPRO()->helpers->translate( "This description is uniquely made for the <strong>create_path_attachment</strong> webhook action.", $translation_ident ); ?>
<br>
...
<br><br>
<h4><?php echo WPWHPRO()->helpers->translate( "How to use <strong>create_path_attachment</strong>", $translation_ident ); ?></h4>
<ol>
    <li><?php echo WPWHPRO()->helpers->translate( "The first argument you need to set within your webhook action request is the <strong>action</strong> argument. This argument is always required. Please set it to <strong>create_path_attachment</strong>.", $translation_ident ); ?></li>
    <li><?php echo WPWHPRO()->helpers->translate( "It is also required to set the <strong>path</strong> argument. Please set it to the relative path of the media you want to create as an attachment within WordPress.", $translation_ident ); ?></li>
    <li><?php echo WPWHPRO()->helpers->translate( "All the other arguments are optional and just extend the functionality.", $translation_ident ); ?></li>
</ol>
<br><br>
<h4><?php echo WPWHPRO()->helpers->translate( "Special Arguments", $translation_ident ); ?></h4>
<br>
<h5><?php echo WPWHPRO()->helpers->translate( "path", $translation_ident ); ?></h5>
...
<hr>
<h5><?php echo WPWHPRO()->helpers->translate( "file_name", $translation_ident ); ?></h5>
...
<h5><?php echo WPWHPRO()->helpers->translate( "add_post_thumbnail", $translation_ident ); ?></h5>
