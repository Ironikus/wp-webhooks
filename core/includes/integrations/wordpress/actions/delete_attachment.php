...
if ( ! class_exists( 'WP_Webhooks_Integrations_wordpress_Actions_delete_attachment' ) ) :
	...
	class WP_Webhooks_Integrations_wordpress_Actions_delete_attachment {
        ...
        public function get_details(){
			...
			ob_start();
			?>
<?php echo WPWHPRO()->helpers->translate( "This webhook action is used to delete an attachment on your WordPress system via a webhook call.", $translation_ident ); ?>
<br>
<?php echo WPWHPRO()->helpers->translate( "This description is uniquely made for the <strong>delete_attachment</strong> webhook action.", $translation_ident ); ?>
<br>
...
<br><br>
<h4><?php echo WPWHPRO()->helpers->translate( "How to use <strong>delete_attachment</strong>", $translation_ident ); ?></h4>
<ol>
    <li><?php echo WPWHPRO()->helpers->translate( "The first argument you need to set within your webhook action request is the <strong>action</strong> argument. This argument is always required. Please set it to <strong>delete_attachment</strong>.", $translation_ident ); ?></li>
    <li><?php echo WPWHPRO()->helpers->translate( "It is also required to set the <strong>attachment_id</strong> argument. Please set it to the attachmant id of the file you want to delete within WordPress.", $translation_ident ); ?></li>
