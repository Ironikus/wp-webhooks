...
<?php echo WPWHPRO()->helpers->translate( "This webhook action is used to install a plugin on your WordPress system via a webhook call.", $translation_ident ); ?>
<br>
<?php echo WPWHPRO()->helpers->translate( "This description is uniquely made for the <strong>plugin_install</strong> webhook action.", $translation_ident ); ?>
<br>
...
<br><br>
<h4><?php echo WPWHPRO()->helpers->translate( "How to use <strong>plugin_install</strong>", $translation_ident ); ?></h4>
<ol>
    <li><?php echo WPWHPRO()->helpers->translate( "The first argument you need to set within your webhook action request is the <strong>action</strong> argument. This argument is always required. Please set it to <strong>plugin_install</strong>.", $translation_ident ); ?></li>
    ...
    <li><?php echo WPWHPRO()->helpers->translate( "It is also required to define the <strong>plugin_download</strong> argument. You need to set the plugin ZIP file here. This file will be the one you install.", $translation_ident ); ?></li>
