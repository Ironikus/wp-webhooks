...
$return_args = array(
    ...
    'data'      => array(
        ...
        'post_data' => null
			...
			ob_start();
?>
<?php echo WPWHPRO()->helpers->translate( "This webhook action is used to update a post on your WordPress system via a webhook call.", $translation_ident ); ?>
<br>
<?php echo WPWHPRO()->helpers->translate( "The description is uniquely made for the <strong>update_post</strong> webhook action.", $translation_ident ); ?>
<br>
...
<br><br>
<h4><?php echo WPWHPRO()->helpers->translate( "How to use <strong>update_post</strong>", $translation_ident ); ?></h4>
<ol>
    <li><?php echo WPWHPRO()->helpers->translate( "The first argument you need to set within your webhook action request is the <strong>action</strong> argument. This argument is always required. Please set it to <strong>update_post</strong>.", $translation_ident ); ?></li>
    <li><?php echo WPWHPRO()->helpers->translate( "Another argument you need to define is the <strong>post_id</strong>. It contains the ID of the post within your WordPress site.", $translation_ident ); ?></li>
    <li><?php echo WPWHPRO()->helpers->translate( "All the other arguments are optional and just extend the updating process of the post.", $translation_ident ); ?></li>
</ol>
<br><br>
<h4><?php echo WPWHPRO()->helpers->translate( "Tipps", $translation_ident ); ?></h4>
<ol>
    <li><?php echo WPWHPRO()->helpers->translate( "To update a post, you only need to set the values you want to update. The undefined settings won't be overwritten.", $translation_ident ); ?></li>
    <li><?php echo WPWHPRO()->helpers->translate( "In case you want to create the post if it does not exists at that point, you can set the <strong>create_if_none</strong> argument to <strong>yes</strong>", $translation_ident ); ?></li>
</ol>
<?php
			...
			return array(
				'action'            => 'update_post',
				'name'              => WPWHPRO()->helpers->translate( 'Update a post', $translation_ident ),
				'parameter'         => $parameter,
				'returns'           => $returns,
