	...
	class WP_Webhooks_Integrations_wordpress_Actions_update_comment {
        ...
        public function get_details(){
			...
			?>
				...
				<br><br>
				<?php echo WPWHPRO()->helpers->translate( 'This is an example on how you can include the post meta using JSON. (If you set the meta value to "ironikus-delete", it will remove the existing value.)', $translation_ident ); ?>
				<br>
				<pre>
{
