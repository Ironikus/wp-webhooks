...
<?php echo WPWHPRO()->helpers->translate( "This webhook action is used to deactivate a plugin on your WordPress system via a webhook call.", $translation_ident ); ?>
<br>
<?php echo WPWHPRO()->helpers->translate( "This description is uniquely made for the <strong>plugin_deactivate</strong> webhook action.", $translation_ident ); ?>
<br>
...
<br><br>
<h4><?php echo WPWHPRO()->helpers->translate( "How to use <strong>plugin_deactivate</strong>", $translation_ident ); ?></h4>
<ol>
    <li><?php echo WPWHPRO()->helpers->translate( "The first argument you need to set within your webhook action request is the <strong>action</strong> argument. This argument is always required. Please set it to <strong>plugin_deactivate</strong>.", $translation_ident ); ?></li>
    ...
    <li><?php echo WPWHPRO()->helpers->translate( "All the other arguments are optional and just extend the fetching of the posts.", $translation_ident ); ?></li>
            ...
            return array(
                ...
                'name'              => WPWHPRO()->helpers->translate( 'Deactivate a plugin', $translation_ident ),
                'parameter'         => $parameter,
                'returns'           => $returns,
