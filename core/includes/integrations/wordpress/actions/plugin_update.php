...
<?php echo WPWHPRO()->helpers->translate( "This webhook action is used to update a plugin on your WordPress system via a webhook call.", $translation_ident ); ?>
<br>
<?php echo WPWHPRO()->helpers->translate( "<strong>Please note</strong>: The update of a plugin requires the plugin to be hosted on WordPress.org or by using a custom update class like Easy Digital Downloads offers it.", $translation_ident ); ?>
<br>
<?php echo WPWHPRO()->helpers->translate( "This description is uniquely made for the <strong>plugin_update</strong> webhook action.", $translation_ident ); ?>
<br>
...
<br><br>
<h4><?php echo WPWHPRO()->helpers->translate( "How to use <strong>plugin_update</strong>", $translation_ident ); ?></h4>
<ol>
    <li><?php echo WPWHPRO()->helpers->translate( "The first argument you need to set within your webhook action request is the <strong>action</strong> argument. This argument is always required. Please set it to <strong>plugin_update</strong>.", $translation_ident ); ?></li>
    <li><?php echo WPWHPRO()->helpers->translate( "The second argument is <strong>plugin_slug</strong>, which contains the slug of the given plugin. Please check the <strong>Special Arguments</strong> down below for further details.", $translation_ident ); ?></li>
    <li><?php echo WPWHPRO()->helpers->translate( "All the other arguments are optional and just extend the fetching of the posts.", $translation_ident ); ?></li>
            ...
            return array(
                ...
                'name'              => WPWHPRO()->helpers->translate( 'Update a plugin', $translation_ident ),
                'parameter'         => $parameter,
                'returns'           => $returns,
