...
<pre>add_action( 'edd_sl_store_license', array( $this, 'wpwh_trigger_edd_license_creation' ), 10, 4 );</pre>
...
<?php
        ...
        return array(
            ...
            'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires on creation of a license within Easy Digital Downloads.', $translation_ident ),
