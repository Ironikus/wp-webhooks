...
<ol>
	...
	<li>
		...
		<?php echo WPWHPRO()->helpers->translate( "Contains the number of deleted files.", $translation_ident ); ?>
	</li>
</ol>
		<?php
		$parameter['do_action']['description'] = ob_get_clean();
			...
			$description = WPWHPRO()->webhook->get_endpoint_description( 'action', array(
				'webhook_name' => 'Clean uploads folder',
				'webhook_slug' => 'clean_uploads_folder',
				'steps' => array(
					WPWHPRO()->helpers->translate( 'It is also required to set the argument <strong>confirm</strong>, which is needed to confirm that you really want to clear the uploads folder as the action is irreversible.', $translation_ident ),
				),
				'tipps' => array(
					WPWHPRO()->helpers->translate( 'It uses the WP Reset function <strong>do_delete_uploads()</strong> to clean the folder.', $translation_ident ),
				),
			) );
			...
			return array(
				...
				'sentence'			   => WPWHPRO()->helpers->translate( 'clean the WordPress uploads folder', $translation_ident ),
				'parameter'		 => $parameter,
				'returns'		   => $returns,
