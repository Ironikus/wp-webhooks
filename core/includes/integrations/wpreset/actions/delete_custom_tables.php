	...
	class WP_Webhooks_Integrations_wpreset_Actions_delete_custom_tables {
        ...
        */
        public function get_details(){
            ...
            ob_start();
?>
<?php echo WPWHPRO()->helpers->translate( "This webhook action is used to delete all custom tables of your WordPress system via a webhook call.", $translation_ident ); ?>
<br>
<?php echo WPWHPRO()->helpers->translate( "It uses the WP Reset function <strong>do_drop_custom_tables()</strong> to delete custom tables.", $translation_ident ); ?>
<br>
<br>
<?php echo WPWHPRO()->helpers->translate( "This description is uniquely made for the <strong>delete_custom_tables</strong> webhook action.", $translation_ident ); ?>
<br>
...
<br><br>
<h4><?php echo WPWHPRO()->helpers->translate( "How to use <strong>delete_custom_tables</strong>", $translation_ident ); ?></h4>
<ol>
    ...
    <li><?php echo WPWHPRO()->helpers->translate( "It is also required to set the argument <strong>confirm</strong>, which is needed to confirm that you really want to delete the custom tables as the action is irreversible.", $translation_ident ); ?></li>
