...
<ol>
	...
	<li>
		...
		<?php echo WPWHPRO()->helpers->translate( "Contains the number of truncated tables.", $translation_ident ); ?>
	</li>
</ol>
			<?php
			...
			$description = WPWHPRO()->webhook->get_endpoint_description( 'action', array(
				'webhook_name' => 'Truncate custom tables',
				'webhook_slug' => 'truncate_custom_tables',
				'steps' => array(
					WPWHPRO()->helpers->translate( 'It is also required to set the argument <strong>confirm</strong>, which is needed to confirm that you really want to truncate the custom tables as the action is irreversible.', $translation_ident ),
				),
				'tipps' => array(
					WPWHPRO()->helpers->translate( 'It uses the WP Reset function <strong>do_truncate_custom_tables()</strong> to delete custom tables.', $translation_ident ),
				),
			) );
			...
			return array(
				...
				'sentence'			   => WPWHPRO()->helpers->translate( 'truncate custom tables', $translation_ident ),
				'parameter'		 => $parameter,
				'returns'		   => $returns,
