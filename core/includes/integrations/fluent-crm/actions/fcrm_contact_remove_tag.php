...
if ( ! class_exists( 'WP_Webhooks_Integrations_fluent_crm_Actions_fcrm_contact_remove_tag' ) ) :
	...
	public function get_details(){
		...
		$translation_ident = "action-fcrm_contact_remove_tag-content";
			...
			$parameter = array(
				'email'			=> array( 'required' => true, 'short_description' => WPWHPRO()->helpers->translate( 'Set the email of the contact/user you want to remove the tags from.', $translation_ident ) ),
